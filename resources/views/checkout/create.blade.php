                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <form action="{{route('checkout.store', $camp->id)}}" class="basic-form" method="POST">
                                ...
                                <p class="text-danger">{{$errors->first('occupation')}}
                                @endif
                                <div class="mb-4">
                                ...
                                <p class="text-danger">{{$errors->first('card_number')}}
                                @endif
                                <div class="mb-5">
                                    <div class="row">
                                        <div class="col-lg-6 col-12">
                                        ...
                                        @if($errors->has ('expired'))
                                            <p class="text-danger">{{$errors->first('expired')}}
                                        @endif
                                        <div class="col-lg-6 col-12">
                                            <label class="form-label">CVC</label>
                                            <input name="cvc" type="number" class="form-control {{$errors->has('cvc') ? 'is-invalid' : ''}}s" maxlength="3" value="{{old('expired') ?: ''}}" required/>
                                        </div>
                                        @if($errors->has ('cvc'))
                                        <p class="text-danger">{{$errors->first('cvc')}}
                                    @endif
                                    </div>
                                </div>
