        ...
        <div class="container">
            ...
            <div class="row brands">
                <div class="col-lg-12 col-12 text-center">
                    <img src="{{asset('images/brand.png')}}g" alt="">
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-10 col-12">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="item-review">
                                ...
                                <div class="user">
                                    <img src="{{asset('images/rian.png')}}" class="photo" alt="">
                                    <div class="info">
                                        <h4 class="name">
                                            Rian Fitra Aulia Sipayung
                                        </h4>
                                        <p class="role">
                                            CEO at Natsume Corp
                                        </p>
                    ...
                    <div class="row copyright">
                        <div class="col-lg-12 col-12">
                            <p>
                                All Rights Reserved. Copyright Natsume Takashi.
                            </p>
                        </div>
                    </div>
                </div>
